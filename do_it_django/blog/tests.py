...
class TestView(TestCase):
    ...
    def test_comment_update(self):
        comment_by_test01 = Comment.objects.create(
            id = 3,
            post=self.post_001,
            author=self.user_test01,
            content='test01의 댓글입니다.'
        )
        ...
        print("123123", comment_area)
        comment_area = soup.find('div', id='comment-area')
        print("234234", comment_area)
        self.assertFalse(comment_area.find('a', id='comment-2-update-btn'))
        ...
        self.assertIn('test02의 댓글을 수정합니다.', comment_001_div.text)
    ...
    def test_delete_comment(self):
        ...
        self.assertIn('delete', comment_002_delete_modal.btn.text)
        self.assertEqual(
        ...
        self.assertIn('Aru You Sure?', delete_comment_modal_002.text)
        ...
        self.assertNotIn('test01의 댓글입니다.', comment_area.text)
